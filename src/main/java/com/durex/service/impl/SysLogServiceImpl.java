...
import com.durex.dao.*;
import com.durex.dto.SearchLogDto;
    ...
    public void recover(int id) {
        ...
        switch (sysLog.getType()){
            ...
            case LogType.TYPE_ROLE_ACL:
                ...
                sysRoleAclService.changeRoleAcl(sysLog.getTargetId(), JsonMapper.string2Object(sysLog.getOldValue(), new TypeReference<List<Integer>>() {
                }));
                break;
            case LogType.TYPE_ROLE_USER:
                SysRole userRole = sysRoleMapper.selectByPrimaryKey(sysLog.getTargetId());
                Preconditions.checkNotNull(userRole, "角色已经不存在了");
                sysRoleUserService.changeRoleUser(sysLog.getTargetId(), JsonMapper.string2Object(sysLog.getOldValue(), new TypeReference<List<Integer>>() {
                }));
                break;
            default:;
        }
